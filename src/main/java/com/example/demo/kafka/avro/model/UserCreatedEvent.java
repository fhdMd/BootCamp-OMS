 ...
 */
package com.example.demo.kafka.avro.model;
...
public class UserCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5865669753438423477L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserCreatedEvent\",\"namespace\":\"com.example.demo.kafka.avro.model\",\"fields\":[{\"name\":\"userId\",\"type\":\"long\"},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"email\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"eventTimestamp\",\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}]}");
   ...
   */
  public UserCreatedEvent(java.lang.Long userId, java.lang.String name, java.lang.String email, java.lang.Long eventTimestamp) {
    this.userId = userId;
    this.name = name;
    this.email = email;
   ...
   */
  public static com.example.demo.kafka.avro.model.UserCreatedEvent.Builder newBuilder() {
    return new com.example.demo.kafka.avro.model.UserCreatedEvent.Builder();
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.example.demo.kafka.avro.model.UserCreatedEvent.Builder newBuilder(com.example.demo.kafka.avro.model.UserCreatedEvent.Builder other) {
    if (other == null) {
      return new com.example.demo.kafka.avro.model.UserCreatedEvent.Builder();
    } else {
      return new com.example.demo.kafka.avro.model.UserCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.example.demo.kafka.avro.model.UserCreatedEvent.Builder newBuilder(com.example.demo.kafka.avro.model.UserCreatedEvent other) {
    if (other == null) {
      return new com.example.demo.kafka.avro.model.UserCreatedEvent.Builder();
    } else {
      return new com.example.demo.kafka.avro.model.UserCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.demo.kafka.avro.model.UserCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.demo.kafka.avro.model.UserCreatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.kafka.avro.model.UserCreatedEvent.Builder setUserId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.kafka.avro.model.UserCreatedEvent.Builder clearUserId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.kafka.avro.model.UserCreatedEvent.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.kafka.avro.model.UserCreatedEvent.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.kafka.avro.model.UserCreatedEvent.Builder setEmail(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.kafka.avro.model.UserCreatedEvent.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.kafka.avro.model.UserCreatedEvent.Builder setEventTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.kafka.avro.model.UserCreatedEvent.Builder clearEventTimestamp() {
